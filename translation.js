const translations = {
  en: {
    ...
    "skills_cat_pm": "Project management methodologies",
    ...
    "project_1_problem": "The Problem: Modern vehicles are vulnerable to cyber-attacks (like 'hacking' the car's internal communication) that can compromise passenger safety.",
    "project_1_solution": "The Solution: Developed an intelligent security layer that monitors the vehicle's internal 'nervous system' (CAN Bus) in real-time. Using AI, the system 'learns' what normal driving looks like and immediately flags suspicious behavior.",
    "project_1_how_it_works": "How it Works: The system tracks how often messages are sent and checks for 'strange' patterns in the data packets—similar to how a bank detects credit card fraud.",
    "project_1_results_title": "The Results:",
    "project_1_results_li_1": "99.9% Reliability: Virtually zero 'false alarms' during normal driving.",
    "project_1_results_li_2": "Cyber-Attack Detection: Successfully identified over 98% of hacking attempts (including DoS and malicious data injections) before they could affect the vehicle.",
    ...
    "exp_1_client": "Client: Vector Informatik",
    "exp_1_oem": "OEM: Stellantis",
    "exp_1_li_1": "High-Throughput Data Processing: Implemented multicore processing solutions to optimize data transmission and system efficiency for next-generation vehicle platforms.",
    "exp_1_li_2": "Real-Time Anomaly Detection: Developed Safety-critical monitoring functions that identify system risks in real-time, ensuring 100% compliance with international safety standards.",
    "exp_1_li_3": "Stakeholder Engagement: Engaged directly in technical discussions with clients to translate high-level business needs into finalized software requirements and executable technical specifications.",
    
    "exp_2_title": "Lead Engineer | Avin Systems GmbH, Berlin",
    "exp_2_date": "Sep 2019 – July 2021",
    "exp_2_client": "Client: Embeddeers GmbH",
    "exp_2_oem": "OEM: Mercedes-Benz Group AG",
    "exp_2_li_1": "Complex Data Architecture (BMS): Served as a core technical contributor for Battery Management Systems (BMS), driving architectural decisions for monitoring Low Voltage (LVS) and High Voltage (HVS) sensor environments.",
    "exp_2_li_2": "Data Pipeline Standardization: Delivered standardized, Safety-Compliant software stacks that accelerated data integration and reduced time-to-production for electric vehicle (EV) platforms.",
    "exp_2_li_3": "Technical Mentorship: Established code review standards and mentored junior engineers, resulting in a measurable increase in software quality and team coding efficiency.",
    ...
    "edu_1_li_1": "Completed intensive professional training (Weiterbildung) focusing on end-to-end data pipelines, advanced model building, and deployment strategies.",
    "edu_1_li_2": "Intensive program focused on applied machine learning, deep learning architectures (CNNs, Transformers) and Data Engineering.",
    "edu_1_li_3": "Included modules on MLOps, Model Interpretability, and Responsible Al practices.",
    "edu_2_title": "Bachelor of Engineering",
    "edu_2_desc": "B.V.B College of Engineering, India",
    "edu_2_date": "2009 – 2013",
    
    "languages_title": "Languages",
    "languages_details": "English (Fluent), German (B2 Berufliches Deutsch), Telugu (Native), Kannada, Hindi",
  ...
  de: {
    ...
    "skills_cat_pm": "Projektmanagement-Methoden",
    "skills_pm_details": "Agile, Scrum, Kanban, Scaled Agile Framework.",
    ...
    "project_1_problem": "Das Problem: Moderne Fahrzeuge sind anfällig für Cyberangriffe (wie das 'Hacke' der internen Fahrzeugkommunikation), die die Sicherheit der Passagiere gefährden können.",
    "project_1_solution": "Die Lösung: Entwicklung einer intelligenten Sicherheitsebene, die das interne 'Nervensystem' des Fahrzeugs (CAN Bus) in Echtzeit überwacht. Mithilfe von KI 'lernt' das System, wie normales Fahrverhalten aussieht, und kennzeichnet verdächtiges Verhalten sofort.",
    "project_1_how_it_works": "So funktioniert's: Das System verfolgt, wie oft Nachrichten gesendet werden, und sucht nach 'ungewöhnlichen' Mustern in den Datenpaketen – ähnlich wie eine Bank Kreditkartenbetrug erkennt.",
    "project_1_results_title": "Die Ergebnisse:",
    "project_1_results_li_1": "99,9% Zuverlässigkeit: Praktisch null 'Fehlalarme' während des normalen Fahrbetriebs.",
    "project_1_results_li_2": "Cyberangriffserkennung: Erfolgreiche Identifizierung von über 98% der Hacking-Versuche (einschließlich DoS- und böswilliger Dateninjektionen), bevor diese das Fahrzeug beeinträchtigen konnten.",
    ...
    "exp_1_date": "Aug 2021 – Feb 2025",
    "exp_1_client": "Kunde: Vector Informatik",
    "exp_1_oem": "OEM: Stellantis",
    "exp_1_li_1": "Datendurchsatz: Implementierung von Multicore-Verarbeitungslösungen zur Optimierung der Datenübertragung und Systemeffizienz für Fahrzeugplattformen der nächsten Generation.",
    "exp_1_li_2": "Echtzeit-Anomalieerkennung: Entwicklung sicherheitskritischer Überwachungsfunktionen, die Systemrisiken in Echtzeit identifizieren und 100%ige Einhaltung internationaler Sicherheitsstandards gewährleisten.",
    "exp_1_li_3": "Stakeholder-Engagement: Direkte technische Diskussionen mit Kunden, um komplexe Geschäftsanforderungen in fertige Softwareanforderungen und ausführbare technische Spezifikationen zu übersetzen.",
    
    "exp_2_title": "Lead Engineer | Avin Systems GmbH, Berlin",
    "exp_2_date": "Sep 2019 – Juli 2021",
    "exp_2_client": "Kunde: Embeddeers GmbH",
    "exp_2_oem": "OEM: Mercedes-Benz Group AG",
    "exp_2_li_1": "Komplexe Datenarchitektur (BMS): Wesentlicher technischer Beitrag zur Batterie-Management-Systeme (BMS), Förderung architektonischer Entscheidungen zur Überwachung von Nieder- (LVS) und Hochspannungs-Sensorumgebungen (HVS).",
    "exp_2_li_2": "Standardisierung von Datenpipelines: Bereitstellung standardisierter, sicherheitskonformer Software-Stacks, die die Datenintegration beschleunigten und die Markteinführungszeit für Elektrofahrzeugplattformen (EV) verkürzten.",
    "exp_2_li_3": "Technisches Mentoring: Etablierung von Code-Review-Standards und Mentoring von Junior-Ingenieuren, was zu einer messbaren Steigerung der Softwarequalität und der Effizienz der Teamkodierung führte.",
    ...
    "edu_1_li_1": "Intensives berufliches Training (Weiterbildung) mit Fokus auf End-to-End-Datenpipelines, fortschrittliche Modellentwicklung und Bereitstellungsstrategien abgeschlossen.",
    "edu_1_li_2": "Intensivprogramm konzentrierte sich auf angewandtes maschinelles Lernen, Deep-Learning-Architekturen (CNNs, Transformer) und Data Engineering.",
    "edu_1_li_3": "Umfasste Module zu MLOps, Modellinterpretierbarkeit und verantwortungsvollen KI-Praktiken.",
    "edu_2_title": "Bachelor of Engineering",
    "edu_2_desc": "B.V.B College of Engineering, Indien",
    "edu_2_date": "2009 – 2013",
    
    "languages_title": "Sprachen",
    "languages_details": "Englisch (Fließend), Deutsch (B2 Berufliches Deutsch), Telugu, Kannada, Hindi",
